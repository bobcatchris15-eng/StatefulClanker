...
$runtimeNames=@('StatefulClanker.Core.ps1','StatefulClanker.Context.ps1','StatefulClanker.Execution.ps1','StatefulClanker.Concurrency.ps1')
...
if($StateRoot){Set-SCRoots (Get-Location).Path $StateRoot}
