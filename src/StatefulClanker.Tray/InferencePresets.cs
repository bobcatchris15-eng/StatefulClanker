...
static class InferencePresets
{
    public static readonly InferencePreset[] All =
    {
        ...
        new("9router","9Router gateway","http://127.0.0.1:20128/v1","/models","openai",false,true,
            ...
            Provenance:"9Router"),
        new("github-models","GitHub Models","https://models.github.ai/inference","/models","openai",false,true,
            "Free GitHub Models quota","github_pat_...","https://github.com/marketplace/models",
            "Create a GitHub token permitted to use GitHub Models. This preset uses the current models.github.ai OpenAI-compatible inference endpoint.",
            FreePoolProvider:true,Provenance:"FreeLLMAPI"),
