...
static class InferencePresets
{
    public static readonly InferencePreset[] All =
    {
        ...
        new("gemini","Google Gemini API / AI Studio","https://generativelanguage.googleapis.com/v1beta/openai","/models","openai",false,true,
            ...
            "Open Google AI Studio, create a Gemini API key, and paste it here. StatefulClanker uses Google's OpenAI-compatible endpoint and discovers the models enabled for that key.", FreePoolProvider:true, Provenance:"FreeLLMAPI + 9Router"),
