...
static class InferencePresets
{
    public static readonly InferencePreset[] All =
    {
        ...
        new("nvidia","NVIDIA NIM / build.nvidia.com","https://integrate.api.nvidia.com/v1","/models","openai",false,true,
            ...
            "Join the free NVIDIA Developer Program, open a model on build.nvidia.com, choose Prototype / API, and generate an API key. Free endpoint availability is intended for development and experimentation.", FreePoolProvider:true, Provenance:"FreeLLMAPI + 9Router"),
        ...
        new("github-models","GitHub Models (retired)","https://models.github.ai/inference","/models","openai",false,true,
            "Retired July 30, 2026","github_pat_...","https://github.blog/changelog/2026-07-01-github-models-is-being-fully-retired-on-july-30-2026/",
            "GitHub Models was fully retired on July 30, 2026. This compatibility preset is retained only so older saved connections remain recognizable; do not add it as inference capacity.",
            FreePoolProvider:false,Provenance:"StatefulClanker legacy"),
