...
sealed class ApiConnectionsPage : TabPage
{
    ...
    public ApiConnectionsPage() : base("API Connections")
    {
        ...
        _grid.Columns.Add("id","Connection"); _grid.Columns.Add("protocol","Protocol"); _grid.Columns.Add("url","Base URL"); _grid.Columns.Add("model","Model"); _grid.Columns.Add("tools","Tools"); _grid.Columns.Add("auth","Auth"); rows.Controls.Add(_grid,0,2); Controls.Add(rows); Theme.Apply(this); Reload();
    }
